...
$EndDescr
$Comp
L ARM-Board-rescue:SD_WM6698CT-ND-ARMlib-ARM-Board-rescue-Payload_Connections J3
U 1 1 5BE5108C
P 12350 8150
F 0 "J3" H 12828 8252 60  0000 L CNN
F 1 "SD_WM6698CT-ND" H 12828 8146 60  0000 L CNN
F 2 "" V 12300 8050 60  0001 C CNN
...
$Comp
L ARM-Board-rescue:Conn_01x20_Female-Payload_Connections J4
U 1 1 5BE939D5
P 1450 9250
F 0 "J4" H 1444 7975 50  0000 C CNN
F 1 "Conn_01x20_Female" H 1444 8066 50  0000 C CNN
F 2 "Payload_Connectors:IO_Connector" H 1500 9200 50  0001 C CNN
...
$Comp
L ARM-Board-rescue:SD_WM6698CT-ND-ARMlib-ARM-Board-rescue-Payload_Connections J6
U 1 1 5BFE231B
P 14200 8450
F 0 "J6" H 14678 8552 60  0000 L CNN
F 1 "SD_WM6698CT-ND" H 14678 8446 60  0000 L CNN
F 2 "" V 14150 8350 60  0001 C CNN
...
SD Card Logging
$Comp
L ARM-Board-rescue:SRAM_23LC1024T-I_ST-ARMlib-Payload_Microcontrollers U3
U 1 1 5BFFCC54
P 12700 5550
...
RAM
Text GLabel 11500 8100 1    50   Input ~ 0
VDD33
...
Wire Wire Line
	4400 5200 5250 5200
$Comp
L ARM-Board-rescue:STM32L4x6RxT6-symbols-Payload_Microcontrollers U2
U 1 1 5C039DAA
P 7950 5350
...
VBUS
$Comp
L ARM-Board-rescue:LD39200PU33R-Payload_Regulators VR1
U 1 1 5C09F3A5
P 4100 2250
...
$Comp
L ARM-Board-rescue:Harwin_M80-5400642-Payload_Connections J5
U 1 1 5C184B36
P 3650 6800
...
$EndComp
$Comp
L ARM-Board-rescue:MCP2562-canhw-Payload_Canhw U4
U 1 1 5C184EB2
P 5300 7100
...
F 1 "SW_SPST" H 2350 3594 50  0000 C CNN
F 2 "ARMlib:SPST_GF-123-0054" H 2350 3450 50  0001 C CNN
...
U 1 1 5C2102C6
P 7200 6750
F 0 "R4" H 7270 6796 50  0000 L CNN
F 1 "DNP" H 7270 6705 50  0000 L CNN
F 2 "Resistors_SMD:R_0603" V 7130 6750 50  0001 C CNN
...
$EndComp
$Comp
L ARM-Board-rescue:STM32L4x6RxT6-symbols-ARM-Board-rescue-Payload_Microcontrollers U1
U 2 1 5C15893F
P 9500 3100
...
F 2 "Payload_Connectors:JTAG_CONN_20021311-00010T4LF" H 1350 5450 50  0001 C CNN
