...
public class Shutdown_Confirm extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_shutdown_confirm, container, false);
        ...
        Button button_reset_yes = (Button)view.findViewById(R.id.button_shutdown_yes);
        setOnClick(button_reset_yes, "SLEEP");

        Button button_reset_no = (Button)view.findViewById(R.id.button_shutdown_no);
