...
public class Wakeup_Confirm extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_wakeup_confirm, container, false);
        ...
        Button button_disarm_yes = (Button)view.findViewById(R.id.button_wakeup_yes);
        setOnClick(button_disarm_yes, "DISARMED");

        Button button_disarm_no = (Button)view.findViewById(R.id.button_wakeup_no);
